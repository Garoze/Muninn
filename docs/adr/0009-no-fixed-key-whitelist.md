...
Muninn's underlying source data — a ConfigMap's `data` field, or any
other registered source's fields (see
[ADR-0008](0008-pluggable-config-source.md)) — is inherently arbitrary
key-value pairs, not a fixed schema. An explicit, hand-maintained
