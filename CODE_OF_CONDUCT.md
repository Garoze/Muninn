...
This Code of Conduct applies within project spaces — issues, pull
requests, and discussions on this repository — and when an individual is
officially representing the project in public. Examples of official
representation are using an official project email address, posting from
an official project social media account, or acting as an appointed
representative at an online or offline event.

It does not apply to a contributor's personal accounts, personal
conduct, or activity unrelated to this project.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior
within the scope above may be reported to the maintainer at
**marcelogaroze@hotmail.com**. All complaints will be reviewed and
